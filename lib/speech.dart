...
import 'init_speech.dart';
import 'recognition_results.dart';
import 'session_option.dart';
import 'speech_controller.dart';
import 'speech_status.dart';
...
class _SpeechSampleAppState extends State<SpeechSampleApp> {
  ...
  Future<void> initSpeechState() async {
    ...
    try {
      ...
      setState(() {
        lastError = 'Ses tanamasy şowsuz boldy: ${e.toString()}';
        _hasSpeech = false;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Gepleşigi tanamak mümkinçiligi'),
        centerTitle: true,
      ),
